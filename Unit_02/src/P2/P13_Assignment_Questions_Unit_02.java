...
abstract class Sample2{
	...
	public int b=20;//can only be accessed outside Unit_02 Package but within same package
	protected int c=30;//can only be accessed within Unit_02 Package
	private int d=40; //within ParentClass only,not even in it's sub-class
